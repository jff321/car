...
// 获取赛道券
export const myCoupon = (data, callback) => post('coupon.trackCoupon', data, callback)

// 创建赛道券地址
export const createTrackOrder = (data, callback) => post('order.createTrackOrder', data, callback)
